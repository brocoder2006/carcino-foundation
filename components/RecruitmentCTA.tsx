    ...
    <section id="recruitment" className="relative py-20 lg:py-28 bg-[#0B0F1A]">
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        <motion.div
          ...
          className="bg-[#0E0C18]/95 border border-purple-500/25 rounded-[2.5rem] p-8 sm:p-12 md:p-16 relative overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.6)] flex flex-col lg:flex-row items-center justify-between gap-10"
        >
          ...
          <div className="relative z-10 max-w-xl text-left">
            <h2 className="font-editorial italic text-[clamp(2.4rem,5vw,3.75rem)] text-[#E9D5FF] tracking-wide leading-[1.1] mb-4 font-[400]">
              ...
              {teamButtons.map((item) => {
                ...
                return (
                  <button
                    ...
                    className="bg-[#1A1329]/90 hover:bg-[#2A1B43] border border-white/15 hover:border-purple-400/60 text-purple-100 hover:text-white px-5 py-2.5 rounded-full text-xs sm:text-sm font-medium inline-flex items-center gap-1.5 transition-all shadow-md hover:scale-105 cursor-pointer"
                  >
          ...
          <div className="relative z-10 flex-shrink-0 flex items-center justify-center">
            <svg
              ...
              fill="none"
              stroke="currentColor"
              className="w-56 h-56 sm:w-72 sm:h-72 text-purple-400/70 drop-shadow-[0_0_20px_rgba(168,85,247,0.3)] stroke-[2.2] stroke-linecap-round stroke-linejoin-round"
            >
              ...
              {/* Inner Face Silhouette Profile inside Ribbon */}
